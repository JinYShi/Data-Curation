	...
	<div class="container">
		...
		<div class="starter-template">
			...
			<div class="alert alert-warning">
			        <a href="/get10" class="btn btn-xs btn-warning pull-right">Get the records</a>
			        <strong>Generate 10 records randomly</strong>
			</div>
			
			<div class="alert alert-danger">
			        <a href="/get100" class="btn btn-xs btn-danger pull-right">Get the records</a>
			        <strong>Generate 100 records randomly</strong>
			 </div>
			 <div class="alert alert-info">
			        <a href="/get1000" class="btn btn-xs btn-primary pull-right">Get the records</a>
